...
require (
	...
	github.com/bazelbuild/remote-apis-sdks v0.0.0-20240220194329-fe2abae45cc6
	github.com/dgraph-io/ristretto v0.1.1
	github.com/dustin/go-humanize v1.0.1
	github.com/go-redis/redis/v8 v8.11.5
	github.com/golang/protobuf v1.5.3
	github.com/golang/snappy v0.0.4 // indirect; This is a required dep that Go mod tidy gets rid of. This breaks Please if it gets removed though.
	github.com/google/go-cmp v0.6.0 // indirect; This is a required dep that Go mod tidy gets rid of. This breaks Please if it gets removed though.
